  ...
  return (
    <footer className="border-t-2 border-primary/35 bg-surface-muted" aria-label="Site footer">
      <Container className="py-11 sm:py-12 lg:py-14">
        <div className="grid gap-9 sm:grid-cols-2 lg:grid-cols-[1.45fr_repeat(4,minmax(0,1fr))] lg:items-start lg:gap-0">
